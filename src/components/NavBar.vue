...
<nav class="bg-white border-gray-200 dark:bg-gray-950">
  <div class="max-w-screen-xl  flex flex-wrap justify-between items-center mx-auto  p-4">
    <ul class="font-medium flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-950 dark:border-gray-700">
        <li>
    ...
    <div class="flex w-full md:block md:w-auto " id="navbar-default">
      <div class="flex items-center w-full ">
       <a  class=" space-x-3 rtl:space-x-reverse">
        <img src="../assets/ORCUN.png" class="h-10" alt="Flowbite Logo" />
    </a>
